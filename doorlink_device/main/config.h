...
#define BLE_SCAN_WINDOW_UNITS                                                  \
  0x0030 /* 30 ms, 0.625 ms units (gives Wi-Fi airtime) */
...
#define BEACON_RSSI_THRESHOLD_DBM (-92)
#define BEACON_ARRIVED_RSSI_DBM (-82)
...
#define SENSOR_TYPE_VL6180X           1
#define SENSOR_TYPE_VL53L0X           2

/* Active laser distance sensor selection: SENSOR_TYPE_VL53L0X or SENSOR_TYPE_VL6180X */
#define CONFIG_SENSOR_TYPE            SENSOR_TYPE_VL53L0X

#define SENSOR_I2C_PORT               I2C_NUM_0
#define SENSOR_I2C_SDA_GPIO           18
#define SENSOR_I2C_SCL_GPIO           19
#define SENSOR_I2C_CLK_SPEED_HZ       100000
#define SENSOR_POLL_MS                200
#define SENSOR_MEASUREMENT_TIMEOUT_MS 500

#if CONFIG_SENSOR_TYPE == SENSOR_TYPE_VL53L0X
#define SENSOR_PRESENCE_THRESHOLD_MM  400
#else
#define SENSOR_PRESENCE_THRESHOLD_MM  150
#endif
...
#define MFG_TEST_ENTRY                                                         \
  {.manufacturer_id = 0x0143, .name_text = "7836F9853359AD65"}
